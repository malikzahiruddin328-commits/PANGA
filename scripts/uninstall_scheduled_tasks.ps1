# Removes the 3 Windows Task Scheduler tasks install_scheduled_tasks.ps1
# registers (native-packaging branch, 2026-07-31). Safe to run even if some
# or all of them were never registered - each removal is best-effort.
#
...
$TaskNames = @("${TaskPrefix}DailyJobSearch", "${TaskPrefix}GmailCtaScan", "${TaskPrefix}CtaFulfillment")
